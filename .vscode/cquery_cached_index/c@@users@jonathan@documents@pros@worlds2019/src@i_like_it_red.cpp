...
static lv_res_t setAuton(lv_obj_t * btn){
  ...
  // 2: Front tile, side pole and park (14)       //
  // 3: Front tile, mid pole and park (8)         //
  // 4: Back tile, side pole and park (13)        //
  // 5: Back tile, 2 floor caps and park (6)      //
...
static const string display_map[] = {"1 Red","2 Red","3 Red","4 Red","5 Red","1 Blue","2 Blue","3 Blue","4 Blue","5 Blue"};
